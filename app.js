...
// Respond to OPTIONS request by browser -- here app.options means any http verb eg, GET, POST etc
app.options('*', cors());

// optionally enable OPTIONS request to be responded on a particular route
